...
so we know there is one precompile at address 0x8 that implements the pairing math following the specifications of EIP 197

here is one way to do that in solidity : 
